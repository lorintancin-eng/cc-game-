...
- **Progress**: 哪吒 **trio + full progression** ✅ — Slices 1-4c: 三昧真火 + 火尖枪 + 乾坤圈 + 混天绫 + select/HUD + upgrade-pool (unlock+enhance) + unlock gating (火尖枪 initial; 乾坤圈/混天绫 unlock via level-up). CI `826706b`, **235 unit + 10 integration green**. Next: Slice 4d 火尖枪 burning ground (small, last 哪吒 piece) → then 杨戬 (summon system first).
